...
## Project Structure
    ...
    ├── testapiautostorybo_117029  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_117029`
...
2. Clone this repo and `cd testapiautostorybo_117029`
